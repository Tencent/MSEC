 ...
 */
public class SecondLevelServiceConfigTag {
    String first_level_service_name;
    String second_level_service_name;
    String tag_name;
    String memo;

    public static String getConfigFileName(String flsn, String slsn, String tag)
    {
        String rootdir = ServletConfig.fileServerRootDir;
        String filename = rootdir+ File.separator+"ConfigFile"+File.separator+flsn+"."+slsn+"."+tag+".cnf";
        return filename;
    }
