 ...
 */
public class SharedobjectTag {
    String tag_name;
    String memo;
    String first_level_service_name;
    String second_level_service_name;

    public static String getSharedobjectName(String flsn, String slsn, String tagName, String suffix)
    {
        String rootdir = ServletConfig.fileServerRootDir;
        String filename = rootdir+ File.separator+"sharedobject"+File.separator+flsn+"."+slsn+"."+tagName+"."+suffix;
        return filename;
    }
