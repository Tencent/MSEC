...
<head>
  ...
  <script type="text/javascript">
      ...
      function onNextBtnClicked()
      {
          ...
          {
              showTips("IP should not be empty.");
              return;
          }
         ...
         // console.log(ipList);
          var   request={
              "handleClass":"beans.service.ChangeOddCapacity",
              "requestBody": {
                  ...
                  function(data, status){
                      ...
                      if (status == "success") {//http通信返回200
                          if (data.status == 0) {//业务处理成功
                              ...
                              var url="/pages/changeOddCapacitySteps/step2.jsp?service_name="+g_service_name+
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      function onActionTypeChanged()
      {
          ...
          for (i = 0; i < iparr.length; ++i)
          {
              ...
              //var ipinfo = {"ip":rec.ip, "port":rec.port, "status":rec.status};
              str += "<option value ='"+JSON.stringify(iparr[i])+"'>"+JSON.stringify(iparr[i])+"</option>\r\n";
          }
          $("#ip_port_list").empty();
          $(str).appendTo("#ip_port_list");
...
<div id="title_bar" class="title_bar_style">
    ...
    <label for="second_level_service_name">【异构服务的扩缩容&nbsp;step1】&nbsp;&nbsp;服务名:</label>
