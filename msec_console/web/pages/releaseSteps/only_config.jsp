...
<head>
  ...
  <script type="text/javascript">
      ...
      function onNextBtnClicked()
      {
          ...
          var selectedStr = $("#config_version_list").val();
...
<div id="title_bar" class="title_bar_style">
    ...
    <label for="second_level_service_name">【只发布配置文件】&nbsp&nbsp服务名:</label>
...
<!--------------------------------------------------------------------------------->
    ...
    <div  class="form_style" id="div_config" style="margin-left: 10px;margin-right: 10px;">
        ...
        <div>
            <label for="div_config"  >选择配置文件版本:</label>
            <select id="config_version_list" size="8"  class="form-control"  >
            </select>
