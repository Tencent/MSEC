...
<head>
  ...
  <script type="text/javascript">
      ...
      function onNextBtnClicked()
      {
          ...
          var   request={
              "handleClass":"beans.service.DownloadDevGO",
              "requestBody": {
                  ...
                  function(data, status){
                      ...
                      if (status == "success") {//http通信返回200
                          if (data.status == 0) {//业务处理成功
                              ...
                              var url="/pages/downloadDevSteps/step2.jsp?service="+g_service_name+
...
<div id="title_bar" class="title_bar_style">
    ...
    <label for="second_level_service_name">【获取开发环境&nbsp;step2】&nbsp&nbsp服务名:</label>
