...
<head>
  ...
  <script type="text/javascript">
      ...
      function showConfigInLB()
      {
          //console.log("begin to load detail info...");
          var request = {
              "handleClass": "beans.service.QueryConfigInLB",
              "requestBody": {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
                              ...
                              $.each(data.ip_list, function (i, rec) {
...
<div id="title_bar" class="title_bar_style">
    ...
    <label for="second_level_service_name">【服务的扩缩容&nbsp;step2】&nbsp;&nbsp;服务名:</label>
