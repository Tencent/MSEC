...
<div class="menu_tree">
    <ul>
      <li><a href="#" ref="">redis集群</a></li>
        <ul>
           <li><a href="/pages/StandardServiceMaintenance.jsp" ref="leaf">【增/删集群】</a></li>
            <%=printService()%>
        </ul>
...
<!--这部分是静态的-->
        ...
        <li><a href="#" ref="">客户端Agent下载</a></li>
        <ul>
            <li><a href="/pages/download.jsp" ref="leaf">下载</a></li>
        </ul>
