...
public class InstallPlanRequest {
    ...
    ArrayList<ServerInfo> added_servers;
    ...
    public ArrayList<ServerInfo> getAdded_servers() {
        return added_servers;
    }

    public void setAdded_servers(ArrayList<ServerInfo> added_servers) {
        this.added_servers = added_servers;
    }
}
