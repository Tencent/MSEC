...
public class RemovePlanRequest {
    ...
    public ArrayList<String> getRemove_ips() {
        return remove_ips;
    }

    public void setRemove_ips(ArrayList<String> remove_ips) {
        this.remove_ips = remove_ips;
    }
}
